...
class CreateData {
    async run(_, connection) {
        const password = await bcrypt_1.default.hash("123456", 6);
        ...
        await connection
            ...
            .execute();
        const john = await User_1.default.findOne({ username: "john" });
        const jane = await User_1.default.findOne({ username: "jane" });
        await connection
            .createQueryBuilder()
            .insert()
            .into(Subleddit_1.default)
            .values([
            {
                name: "reactjs",
            ...
            .execute();
        const reactJsSub = await Subleddit_1.default.findOne({ where: { name: "reactjs" } });
        const funnySub = await Subleddit_1.default.findOne({ where: { name: "funny" } });
        const iqSub = await Subleddit_1.default.findOne({ where: { name: "InsightfulQuestions" } });
        const oneliners = await Subleddit_1.default.findOne({ where: { name: "oneliners" } });
        await connection
            .createQueryBuilder()
            .insert()
            .into(Post_1.default)
            ...
            .execute();
        const post6 = await Post_1.default.findOne(6);
        const post7 = await Post_1.default.findOne(7);
        const post8 = await Post_1.default.findOne(8);
        const post9 = await Post_1.default.findOne(9);
        await connection
            .createQueryBuilder()
            .insert()
            ...
            .execute();
        const comment1 = await Comment_1.default.findOne(1);
        const comment2 = await Comment_1.default.findOne(2);
        await connection
            .createQueryBuilder()
            .insert()
            .into(Vote_1.default)
